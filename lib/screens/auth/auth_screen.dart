...
class _AuthScreenState extends State<AuthScreen> {
  final TextEditingController _phoneController =
      TextEditingController(); // Restored
    ...
    if (mounted) {
      setState(() {
        ...
        if (foundSims.isNotEmpty) {
          ...
          _errorMessage = null;
          _permissionDenied =
              false; // Clear permission warning if we got a number via Smart Lock
  ...
  String _getLocalizedString(String key) {
    ...
    final strings = <String, Map<String, String>>{
      ...
      'ta': {
        ...
        'primary': 'முதன்மை',
        'terms':
            'தொடர்வதன் மூலம், எங்கள் சேவை விதிமுறைகளை ஒப்புக்கொள்கிறீர்கள்',
      },
    };
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Action button
                          if (!_isDetecting &&
                              (_detectedSims.isNotEmpty || _otpSent))
                            Container(
                              height: 56,
                              decoration: BoxDecoration(
                                gradient: AppColors.primaryGradient,
      ...
      return Center(
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            Text('Permission Required', style: AppTypography.titleMedium),
            const SizedBox(height: 8),
            Text(
      ...
      return Center(
        child: Column(
          children: [
            ...
            const SizedBox(height: 8),
            Text('Please wait...', style: AppTypography.bodySmall),
          ],
        ),
      );
    }
