...
class _SchemesScreenState extends State<SchemesScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: isHindi ? 'इतिहास' : 'History',
          ),
          IconButton(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: Color(0xFF0A192F).withOpacity(0.05),
              blurRadius: 16,
  ...
  void _showEligibilityChecker(BuildContext context, bool isHindi) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const EligibilityFormScreen()),
    );
  }
}
